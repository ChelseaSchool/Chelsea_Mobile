			...
			<div class="col-md-12">
				...
				<div class="nav">
					<ul class="nav nav-tabs" role="tablist">
						...
						<li><a href="#open-house" data-toggle="tab">Open House</a></li>
						<li><a href="#admissions-process" data-toggle="tab">Process</a></li>
					</ul>
				</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							...
							<h2>
								Admissions <small>(Sticky Intro Placeholer)</small>
							</h2>
                            ...
                            <div class="tab-content">
								...
								<div class="tab-pane" id="admissions-process">
